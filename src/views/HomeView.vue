...
<template>
    <h1 class="text-6xl md:text-8xl font-bold text-white text-center">
        <span class="block mb-4">Bienvenido a</span>
        <span class="block bg-clip-text text-transparent bg-gradient-to-r from-green-500 to-blue-500">
            Rick and Morty Team
        </span>
    </h1>
